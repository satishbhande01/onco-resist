...
- Semantic search retrieves relevant papers for any query
- Agent synthesizes database facts with literature evidence in a single response
- Inline PMID citations formatted as clickable PubMed links
